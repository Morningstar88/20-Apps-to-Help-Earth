...
<h2>This repo is an overview of software that our volunteer team hopes to build over the next 2-20 years. Most of these apps are only in the idea stage for now, but some prototypes are up on Codepen. Each app starts to solve critical problems: water shortages, deforestation, poverty, unemployment, and food waste. In 2016, we can create decentralized change without corporate interference...</h2> 
